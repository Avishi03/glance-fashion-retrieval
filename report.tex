...
5. A red tie and a white shirt in a formal setting & \textbf{5/5} & \textbf{0/5} \\
\midrule
\textbf{Precision@5} & \textbf{0.76} & \textbf{0.32} \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{itemize}\small
  ...
  \item \textbf{Precision@5 was judged by the author on 25 image-query pairs.} Small and
        non-blind. Scores also move with rubric strictness: query 2 is 4/5 read
        generously and 2/5 if both business attire \emph{and} an office are required.
        The gap survives either rubric, since vanilla drops too.
